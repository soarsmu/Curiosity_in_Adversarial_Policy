...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', type=str, default='/Desktop/rl_newloss/StarCraftII/StarCraft-results/zero-sum')
    parser.add_argument("--out_dir", type=str, default='/Desktop/rl_newloss/StarCraftII/StarCraft-results/zero-sum')
