...
if __name__ == "__main__":
    ...
    # p.add_argument('--pi1_path', default='/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/multiagent-competition/agent-zoo/you-shall-not-pass/agent1_parameters-v1.pkl')
    # p.add_argument('--pi1_norm_path', default="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/multiagent-competition/agent-zoo/you-shall-not-pass/agent1_parameters-v1.pkl")
    # p.add_argument('--pi0_path', default='/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/multiagent-competition/agent-zoo/you-shall-not-pass/agent2_parameters-v1.pkl')
    # p.add_argument('--pi0_norm_path', default='/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/multiagent-competition/agent-zoo/you-shall-not-pass/agent2_parameters-v1.pkl')
...
#    p.add_argument("--pi0_norm_path", default="/Users/Henryguo/Desktop/rl_newloss/MuJoCo/multiagent-competition/agent-zoo/kick-and-defend/kicker/agent1_parameters-v1.pkl", type=str)
   ...
   #  #
   #  p.add_argument("--pi0_path",
   #                 default="../our agent/retrained/kick/model.pkl",
   #                 type=str)
   #  p.add_argument("--pi0_norm_path",
   #                 default="../multiagent-competition/agent-zoo/kick-and-defend/kicker/agent1_parameters-v1.pkl",
   #                 type=str)
   # #
   # #  # Adv agent
   # #  # ucb adv.
   ...
   # #
   # #  # our adv.
   #  p.add_argument("--pi1_path", default="../adv-agent/our_attack/kick/model.pkl", type=str)
   #  p.add_argument("--pi1_norm_path", default="../adv-agent/our_attack/kick/obs_rms.pkl", type=str)
   # #
   # #  # zoo-agent
   #  p.add_argument("--pi1_type", default="stable", type=str)
   #  p.add_argument("--pi1_nn_type", default="mlp", type=str)
   # #
   #  p.add_argument("--pi1_path", default="../multiagent-competition/agent-zoo/kick-and-defend/defender/agent2_parameters-v3.pkl", type=str)
   #  p.add_argument("--pi1_norm_path", default="../multiagent-competition/agent-zoo/kick-and-defend/defender/agent2_parameters-v3.pkl", type=str)
    ...
    #
    # our adv.
    # p.add_argument("--pi0_path", default="../adv-agent/our_attack/you/model.pkl", type=str)
    # p.add_argument("--pi0_norm_path", default="../adv-agent/our_attack/you/obs_rms.pkl", type=str)
    #
    # zoo-agent
    # p.add_argument("--pi0_type", default="our", type=str)
    # p.add_argument("--pi0_nn_type", default="mlp", type=str)
    # #
    # p.add_argument("--pi0_path", default='../multiagent-competition/agent-zoo/you-shall-not-pass/agent1_parameters-v1.pkl', type=str)
    # p.add_argument("--pi0_norm_path", default="../multiagent-competition/agent-zoo/you-shall-not-pass/agent1_parameters-v1.pkl", type=str) # YouShallNotPass agent2 is the runner
    # #
    # #
    # # victim-agent
    # #
    ...
    # p.add_argument("--pi1_nn_type", default="mlp", type=str)
    # #
    # # p.add_argument("--pi1_path", default='../multiagent-competition/agent-zoo/you-shall-not-pass/agent2_parameters-v1.pkl', type=str)
    # # p.add_argument("--pi1_norm_path", default="../multiagent-competition/agent-zoo/you-shall-not-pass/agent2_parameters-v1.pkl", type=str) # YouShallNotPass agent2 is the runner
    # p.add_argument("--pi1_path", default='/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/our agent/retrained/you/model.pkl', type=str)
    # p.add_argument("--pi1_norm_path", default="../multiagent-competition/agent-zoo/you-shall-not-pass/agent2_parameters-v1.pkl", type=str) # YouShallNotPass agent2 is the runner
    #
    # our retrained vic.
    ...
    # p.add_argument("--pi0_nn_type", default="lstm", type=str)
    #
    # p.add_argument("--pi0_path", default='../our agent/retrained/sumohumans/model.pkl', type=str) # victim
    # p.add_argument("--pi0_norm_path", default="../multiagent-competition/agent-zoo/sumo/humans/agent_parameters-v3.pkl", type=str)
...
#    p.add_argument("--pi0_norm_path", default="/Users/Henryguo/Desktop/rl_newloss/MuJoCo/multiagent-competition/agent-zoo/sumo/humans/agent_parameters-v3.pkl", type=str)
    ...
    # #
    # p.add_argument("--pi1_path", default='../multiagent-competition/agent-zoo/sumo/humans/agent_parameters-v2.pkl', type=str)
    # p.add_argument("--pi1_norm_path", default="../multiagent-competition/agent-zoo/sumo/humans/agent_parameters-v2.pkl", type=str)
...
#    p.add_argument("--pi1_norm_path", default="/Users/Henryguo/Desktop/rl_newloss/MuJoCo/adv_agent-zoo/ucb/humans/obs_rms.pkl", type=str)
    ...
    # our adv.
    # p.add_argument("--pi1_path", default="../adv-agent/our_attack/humans/model.pkl", type=str)
    # p.add_argument("--pi1_norm_path", default="../adv-agent/our_attack/humans/obs_rms.pkl", type=str)
    ...
    p.add_argument("--pi0_path", default='../our agent/retrained/sumoants/model.pkl', type=str) # victim
    p.add_argument("--pi0_norm_path", default='../multiagent-competition/agent-zoo/sumo/ants/agent_parameters-v1.pkl', type=str)
    #
    # # our retrained vic.
    ...
    #
    # # our adv.
    p.add_argument("--pi1_path", default="../adv-agent/our_attack/ants/model.pkl", type=str)
    p.add_argument("--pi1_norm_path", default="../adv-agent/our_attack/ants/obs_rms.pkl", type=str)
    #
    # zoo-agent
    # p.add_argument("--pi1_type", default="our", type=str)
    # p.add_argument("--pi1_nn_type", default="lstm", type=str)
    #
    # p.add_argument("--pi1_path", default='../multiagent-competition/agent-zoo/sumo/ants/agent_parameters-v2.pkl', type=str)
    # p.add_argument("--pi1_norm_path", default='../multiagent-competition/agent-zoo/sumo/ants/agent_parameters-v2.pkl', type=str)
    ...
    # p.add_argument("--pi0_nn_type", default="mlp", type=str)
    # # #
    # p.add_argument("--pi0_path", default='../our agent/retrained/runtogoalants/model.pkl', type=str)
    # p.add_argument("--pi0_norm_path", default="../multiagent-competition/agent-zoo/run-to-goal/ants/agent1_parameters-v1.pkl", type=str)
    #
    # p.add_argument("--pi1_type", default="our", type=str)
    # p.add_argument("--pi1_nn_type", default="mlp", type=str)
    # # #
    # p.add_argument("--pi1_path", default='../multiagent-competition/agent-zoo/run-to-goal/ants/agent2_parameters-v1.pkl', type=str)
    # p.add_argument("--pi1_norm_path", default="../multiagent-competition/agent-zoo/run-to-goal/ants/agent2_parameters-v1.pkl", type=str) # Run To Goal Ants agent2 is the runner
    # # #
