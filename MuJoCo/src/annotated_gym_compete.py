...
CAMERA_CONFIGS = {
    ...
    'default': {
        ...
        'RunToGoalHumans-v0': {'azimuth': 90, 'distance': 8, 'elevation': -23},
        'RunToGoalAnts-v0': {'azimuth': 90, 'distance': 10, 'elevation': -25},
...
class AnnotatedGymCompete(gym.Wrapper):
    ...
    def __init__(self, env, env_name, agent_a_type, agent_a_path, agent_b_type, agent_b_path,
        ...
        # Text overlay
        self.font = ImageFont.truetype('/home/chen/arial.ttf', font_size)
        self.font_bold = ImageFont.truetype('/home/chen/arial.ttf', font_size)
