...
from zoo_utils import setFromFlat, load_from_file, load_from_model, ourSetFromFlat
import os
...
if __name__ == "__main__":
    ...
    p.add_argument("--env", default=0, type=int)

    # YouShallNotPass
    # p.add_argument("--opp-path", default="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/our agent/attack/you/model.pkl", type=str)
    ...
    # p.add_argument("--norm_path", default="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/our agent/attack/you/obs_rms.pkl", type=str)

    # KickAndDefend
    # p.add_argument("--opp-path", default="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/our agent/attack/kick/model.pkl", type=str)
    # # p.add_argument("--opp_path", default="../adv-agent/ucb/kick/model.npy", type=str)
    ...
    # p.add_argument("--norm_path", default="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/our agent/attack/kick/obs_rms.pkl", type=str)
    ...
    # #
    # SumoHumans
    # p.add_argument("--opp-path", default="../adv-agent/rnd_attack/suhuman/model.pkl", type=str)
    # p.add_argument("--opp_path", default="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/our agent/attack/sumohumans/model.pkl", type=str)
    # p.add_argument("--vic_path", default="../multiagent-competition/agent-zoo/sumo/humans/agent_parameters-v2.pkl", type=str)
    # p.add_argument("--norm_path", default="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/our agent/attack/sumohumans/obs_rms.pkl", type=str)
    ...
    # p.add_argument("--opp_path", default="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/our agent/attack/sumoants/model.pkl", type=str)
    ...
    # p.add_argument("--norm_path", default="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/our agent/attack/sumoants/obs_rms.pkl", type=str)

    # RuntoGoalAnts
    # p.add_argument("--opp-path", default="../multiagent-competition/agent-zoo/run-to-goal/ants/agent2_parameters-v1.pkl", type=str)
    p.add_argument("--opp_path", default="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/our agent/attack/runtogoalants/model.pkl", type=str)
    p.add_argument("--vic_path", default="../multiagent-competition/agent-zoo/run-to-goal/ants/agent1_parameters-v1.pkl", type=str)
    p.add_argument("--norm_path", default="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/our agent/attack/runtogoalants/obs_rms.pkl", type=str)

    # RuntoGoalHumans
    # # p.add_argument("--opp-path", default="../multiagent-competition/agent-zoo/run-to-goal/humans/agent2_parameters-v1.pkl", type=str)
    # p.add_argument("--opp_path", default="../adv-agent/rnd_attack/runhuman/model.pkl", type=str)
    # p.add_argument("--vic_path", default="../multiagent-competition/agent-zoo/run-to-goal/humans/agent1_parameters-v1.pkl", type=str)
    # p.add_argument("--norm_path", default="../adv-agent/rnd_attack/runhuman/obs_rms.pkl", type=str)

    # either 'norm', 'ucb_adv', 'our_adv' 'rnd_adv'
    p.add_argument('--opp_type', default='rnd_adv', type=str)
