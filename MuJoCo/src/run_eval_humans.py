...
for seed in seeds_dir:
    ...
    for ckp in checkpoints_dir:
        pi1_path='/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/multiagent-competition/agent-zoo/sumo/humans/agent_parameters-v3.pkl'
        pi1_norm_path='/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/multiagent-competition/agent-zoo/sumo/humans/agent_parameters-v3.pkl'
        pi0_path = '/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/adv-baseline/icml2021/SumoHumans/{}/checkpoints/{}/model.pkl'.format(seed, ckp)
        pi0_norm_path = '/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/adv-baseline/icml2021/SumoHumans/{}/checkpoints/{}/obs_rms.pkl'.format(seed,ckp)
