...
from zoo_utils import MlpPolicyValue, LSTMPolicy, load_from_file, load_from_model, setFromFlat, ourSetFromFlat, ourSetFromFlat
...
def load_adv_agent(ob_space, action_space, n_envs, adv_model_path, adv_ismlp=True, is_rnd=False):
...
class AdvAgent(object):
    def __init__(self, ob_space, action_space, n_envs, adv_model_path, adv_ismlp, adv_obs_normpath=None, is_rnd=False):
        self.agent = load_adv_agent(ob_space, action_space, n_envs, adv_model_path, adv_ismlp, is_rnd=is_rnd)
        self.state = None
...
def make_adv_agent(ob_space, action_space, n_envs, adv_model_path, adv_ismlp, adv_obs_normpath=None, is_rnd=False):
    return AdvAgent(ob_space, action_space, n_envs, adv_model_path, adv_ismlp, adv_obs_normpath, is_rnd=is_rnd)
