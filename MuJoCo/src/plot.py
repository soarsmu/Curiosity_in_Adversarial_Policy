...
def plot_data(log_dir, out_dir, filename, game, length=350, reverse=False):
    ...
    plt.grid(True)
    fig.savefig(out_dir + '/' + filename.split('.')[0]+'_'+print_info[0]+'.png')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', type=str, default='/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/adv-baseline/YouShallNotPass/icml2021_mlp')
    parser.add_argument("--out_dir", type=str, default='/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/adv-baseline/YouShallNotPass/icml2021_mlp')
