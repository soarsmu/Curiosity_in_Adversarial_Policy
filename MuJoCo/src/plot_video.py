...
parser.add_argument("--agent_a_type", type=str, default="ppo2")
parser.add_argument("--agent_a_path", type=str, default="/home/chen/Downloads/our_agent/attack/sumoants/model.pkl")
parser.add_argument("--agent_b_type", type=str, default="zoo")
parser.add_argument("--agent_b_path", type=str, default="/home/chen/adv_rl/multiagent-competition/agent-zoo/sumo/ants/agent_parameters-v1.pkl")
#parser.add_argument("--norm_path", type=str, default=None)
parser.add_argument("--norm_path", type=str, default="/home/chen/Downloads/our_agent/attack/sumoants/obs_rms.pkl")
...
parser.add_argument("--save_dir", type=str, default="/home/chen/Desktop")
