...
for seed in seeds_dir:
    ...
    for ckp in checkpoints_dir:
        pi0_path='/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/multiagent-competition/agent-zoo/kick-and-defend/kicker/agent1_parameters-v1.pkl'
        pi0_norm_path="/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/multiagent-competition/agent-zoo/kick-and-defend/kicker/agent1_parameters-v1.pkl"
        pi1_path = '/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/adv-baseline/icml2021/KickAndDefend/{}/checkpoints/{}/model.pkl'.format(seed, ckp)
        pi1_norm_path = '/home/gc/attack_rl/rl_adv_valuediff/MuJoCo/adv-baseline/icml2021/KickAndDefend/{}/checkpoints/{}/obs_rms.pkl'.format(seed,ckp)
